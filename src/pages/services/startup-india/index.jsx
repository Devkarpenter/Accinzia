  ...
  const services = [
    {
      ...
      path: "/services/startup-india/certification",
    },
    {
      title: "Seed Fund Application",
      path: "/services/startup-india/seed-fund",
    },
    {
      title: "Tax Exemption",
      path: "/services/startup-india/tax-exemption",
    },
    {
      title: "ZOHO Credit (₹1 Lakh)",
      path: "/services/startup-india/zoho-credit",
    },
    {
      title: "Pitch Deck",
      path: "/services/startup-india/pitch-deck",
    },
  ];
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-gray-400 max-w-3xl mx-auto">
            Government-recognized startup services to help you grow faster and smarter.
          </p>
        </div>
